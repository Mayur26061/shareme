      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          <div className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
              <a
                ...
                className="w-8 h-8 bg-stone-400 hover:bg-white text-black rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:shadow-md outline-none"
                rel="noreferrer"
              >
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <input
              className="flex-1 border-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-300 text-black"
              type="text"
            ...
            <button
              type="button"
              className="bg-red-500 rounded-full px-6 py-2 font-semibold text-base outline-none"
              onClick={addComment}
            >
